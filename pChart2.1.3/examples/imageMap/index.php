...
<?php if ( isset($_GET["Action"]) && $_GET["Action"] == "ViewHTML") { 
	$Script = $_GET["Script"]; writeHTML($Script); exit();
} ?>
			...
			<td>
				...
				<table
					...
					<tr>
						...
						<td width=100>&nbsp;<a class=smallLinkGrey href='../'>Examples</a>
						</td>
						...
						<td width=100>&nbsp;<a class=smallLinkGrey
							href='../delayedLoader/'>Delayed loader</a>
						</td>
						<td width=16><img src='../resources/application_view_list.png'
							width=16 height=16 alt='' /></td>
						<td width=100>&nbsp;<b>Image Map</b>
						</td>
					</tr>
				</table>
			</td>
						...
						<td>
							...
							<div
								...
								foreach($Tree as $Key => $Element)
								{
									...
									} else { $Icon = "../resources/dash-explorer.png";
									}
