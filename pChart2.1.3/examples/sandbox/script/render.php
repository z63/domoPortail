...
if ( isset($Axis[0]) )
{
	...
	} else { $myData->setAxisPosition(0,AXIS_POSITION_RIGHT);
	}
...
if ( isset($Axis[1]) )
{
	...
	} else { $myData->setAxisPosition(1,AXIS_POSITION_RIGHT);
	}
...
if ( isset($Axis[2]) )
{
	...
	} else { $myData->setAxisPosition(2,AXIS_POSITION_RIGHT);
	}
...
if ( $g_solid_enabled == "true" )
{
	...
	if ( $g_solid_dashed == "true" ) {
		$Settings["Dash"] = TRUE; $Settings["DashR"]=$R+20; $Settings["DashG"]=$G+20; $Settings["DashB"]=$B+20;
	}
...
if ( $g_title_enabled == "true" )
{
	...
	if ( $g_title_box == "true" ) {
		$TextSettings["DrawBox"] = TRUE; $TextSettings["BoxAlpha"] = 30;
	}
...
if ( $c_family == "plot" )
{
	...
	if ( $c_border_enabled == "true" ) {
		$Config["PlotBorder"] = TRUE; $Config["BorderSize"] = $c_border_size;
	}
...
function stripTail($Values)
{
	...
	$Serialized = "!"; foreach($Result as $Key => $Value) {
