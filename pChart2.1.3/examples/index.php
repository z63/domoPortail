<?php if ( isset($_GET["Action"])) { 
	$Script = $_GET["Script"]; highlight_file($Script); exit();
} ?>
...
<body>
			...
			<td>
				...
				<table
					...
					<tr>
						...
						<td width=100>&nbsp;<b>Examples</b>
						</td>
						<td width=16><img src='resources/application_view_list.png'
							width=16 height=16 alt='' /></td>
						<td width=100>&nbsp;<a class=smallLinkGrey href='sandbox/'>Sandbox</a>
						</td>
						<td width=16><img src='resources/application_view_list.png'
							width=16 height=16 alt='' /></td>
						...
						<td>
							...
							<div
								...
								foreach($Tree as $Key => $Elements)
								{
									...
									} else { $Icon = "dash-explorer.png"; $SubIcon = "dash-explorer-noleaf.png";
									}
									if ( $Key != "z_root" )
									{
	...
	?>
			...
			<td valign='top' style='padding-top: 5px; font-size: 12px;'>
				...
				<table>
					<tr>
						<td><img src='resources/chart_bar.png' width=16 height=16 alt='' />
						</td>
				...
				<div
					...
					<div style='font-size: 10px;' id=render>
						<table>
							<tr>
								<td><img src='resources/accept.png' width=16 height=16 alt="" />
								</td>
